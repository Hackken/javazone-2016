...
public class BlockchainClient {
  ...
  public BlockchainClient(Vertx vertx) {
    this.vertx = vertx;
  }
   ...
   */
  public void subscribe(String address, Handler<JsonObject> handler) {
   ...
   */
  public void subscribeBlocks(Handler<JsonObject> handler) {
    blocks = handler;
   ...
   */
  public void subscribeUnconfirmed(Handler<JsonObject> handler) {
    unconfirmed = handler;
